...
import * as strings from 'KnowledgeDiscoveryHubWebPartStrings';
import { KnowledgeDiscoveryHub } from './components/KnowledgeDiscoveryHub';

export interface IKnowledgeDiscoveryHubWebPartProps {
  title: string;
  useMockData: boolean;
}

export default class KnowledgeDiscoveryHubWebPart extends BaseClientSideWebPart<IKnowledgeDiscoveryHubWebPartProps> {
  public render(): void {
    ReactDom.render(React.createElement(KnowledgeDiscoveryHub, {
      title: this.properties.title || 'Knowledge Discovery Hub',
